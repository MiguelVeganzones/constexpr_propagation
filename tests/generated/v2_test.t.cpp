...
TEST(V2, case_mm)
{
    ...
    constexpr std::array e_data{880.0f, 946.0f, 2464.0f, 2674.0f};

    constexpr std::array a_shape{2uz, 3uz, 4uz};
    constexpr std::array b_shape{4uz, 3uz, 2uz};
    ...
    auto c = tensor_contraction(a,b,cis);
