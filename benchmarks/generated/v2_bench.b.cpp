...
static void BM_tc_case_mm_T_V2(benchmark::State& state)
{
    using F = float;
    ...
    for (auto _ : state)
    {
        benchmark::DoNotOptimize(tensor_contraction(a,b,cis));
    }
}


static void BM_tc_case_rank3_T_V2(benchmark::State& state)
{
    using F = float;
...
static void BM_tc_case_rank4a_T_V2(benchmark::State& state)
{
    using F = float;
...
static void BM_tc_case_rank4b_T_V2(benchmark::State& state)
{
    using F = float;
...
static void BM_tc_case_rank5_T_V2(benchmark::State& state)
{
    using F = float;
...
static void BM_tc_case_rank6_T_V2(benchmark::State& state)
{
    using F = float;
...
static void BM_tc_case_identity_like_T_V2(benchmark::State& state)
{
    using F = float;
...
BENCHMARK(BM_tc_case_mm_T_V2);
BENCHMARK(BM_tc_case_rank3_T_V2);
BENCHMARK(BM_tc_case_rank4a_T_V2);
BENCHMARK(BM_tc_case_rank4b_T_V2);
BENCHMARK(BM_tc_case_rank5_T_V2);
BENCHMARK(BM_tc_case_rank6_T_V2);
BENCHMARK(BM_tc_case_identity_like_T_V2);
BENCHMARK_MAIN();
