...
static void BM_tc_2_2_1_T_T3_C2(benchmark::State& state)
{
    using F = float;
...
BENCHMARK(BM_tc_2_2_1_T_T3_C2);


static void BM_tc_3_3_2_T_T3_C2(benchmark::State& state)
{
    using F = float;
...
BENCHMARK(BM_tc_3_3_2_T_T3_C2);


static void BM_tc_4_4_3_T_T3_C2(benchmark::State& state)
{
    using F = float;
...
BENCHMARK(BM_tc_4_4_3_T_T3_C2);


static void BM_tc_4_4_2_T_T3_C2(benchmark::State& state)
{
    using F = float;
...
BENCHMARK(BM_tc_4_4_2_T_T3_C2);


static void BM_tc_5_5_4_T_T3_C2(benchmark::State& state)
{
    using F = float;
